...
pixi add python-hcl2
# for installing globally
pixi global install python-hcl2
```
...
It is possible to list all of the versions of `python-hcl2` available on your platform:
...
```
pixi search python-hcl2 --channel conda-forge
```
